...
if s:iswin
  ...
  " Ê¹ÓÃguifontwideÉèÖÃÖÐÎÄµÈ¿í×ÖÌå
...
" ====================================================
" Encoding£¨¼æÈÝLinux£©"{{{
" ×¢ÒâÐÂ½¨ÎÄ¼þ¸ú¿ÕÎÄ¼þµÄÇø±ð
" ÐÂ½¨ÎÄ¼þ£ºÊ¹ÓÃvim½¨Á¢µÄÐÂÎÄ¼þ£¬´ËÊ±±àÂë°´ÕÕfileencodingÀ´ÉèÖÃ
" ¿ÕÎÄ¼þ£º  ±ÈÈçÔÚwindowsÏÂ£¬Ê¹ÓÃÓÒ¼üÐÂ½¨ÎÄ±¾ÎÄµµ£¬ÕâÑù¾Í½¨Á¢ÁËÒ»¸ö¿Õ°×ÎÄ¼þ
"           vim´ò¿ª´Ë¿Õ°×ÎÄ¼þ£¬»áÌ½²âÎÄ¼þ±àÂë£¬ÓÉÓÚÎÄ¼þÊÇ¿Õ°×£¬ËùÓÐÌ½²â½á¹û
"           ¿Ï¶¨ÊÇfileencodingsÖÐµÄµÚÒ»¸ö£¨´Ë´¦utf-8£©£¬ÕâÑùÔÚwindowsÏÂÓÃÆä
"           Ëû±à¼­Æ÷´ò¿ªº¬ÓÐÖÐÎÄµÄÎÄ¼þÊ±¾Í»áÂÒÂë¡£(set
"           fenc=chinese)
"           "}}}
" ====================================================
"{{{
...
" ÔÚµ×²¿ÏÔÊ¾±ê³ß£¬ÏÔÊ¾ÐÐºÅÁÐºÅºÍ°Ù·Ö±È
set ruler
...
set laststatus=2   " ÏÔÊ¾×´Ì¬À¸ (Ä¬ÈÏÖµÎª 1, ÎÞ·¨ÏÔÊ¾×´Ì¬À¸)
" ×´Ì¬À¸¸ñÊ½¶¨Òå
set statusline=
...
" ÓÃ¿Õ¸ñ´úÌæÖÆ±í·û
set expandtab
" ÉèÖÃÃ»ÓÐÕ¹¿ªµÄtabËõ½ø4¸ñ
set tabstop=4
"set tabstop=8
" Spaces instead <Tab>.
"set softtabstop=4
" Autoindent width.
" (×Ô¶¯) Ëõ½øÃ¿Ò»²½Ê¹ÓÃµÄ¿Õ°×ÊýÄ¿¡£ÓÃÓÚ 'cindent'¡¢>>¡¢<< µÈ¡£
set shiftwidth=4
...
" ×Ô¶¯Ïòµ±Ç°ÎÄ¼þµÄÉÏ¼¶²éÕÒtagÎÄ¼þ£¬Ö±µ½ÕÒµ½ÎªÖ¹
set tags=./tags;
...
" ----------------------------------------------------
" Ctags"{{{
" Usage:ctags -R --c++-kinds=+p --fields=+ialS --extra=+q "$@"(ÎÄ¼þÄ¿Â¼)
" --c++-kinds=+p £ºÎªC++ÎÄ¼þÔö¼Óº¯ÊýÔ­ÐÍµÄ±êÇ©
" --fields=+ialS £ºÔÚ±êÇ©ÎÄ¼þÖÐ¼ÓÈë¼Ì³ÐÐÅÏ¢(i)¡¢Àà³ÉÔ±µÄ·ÃÎÊ¿ØÖÆÐÅÏ¢(a)
"                  Ô´ÎÄ¼þ°üº¬tag(l)[ÓÃÓÚechofunc.vim]¡¢ÒÔ¼°º¯ÊýµÄÖ¸ÎÆ(S)
" --extra=+q     £ºÎª±êÇ©Ôö¼ÓÀàÐÞÊÎ·û¡£×¢Òâ£¬Èç¹ûÃ»ÓÐ´ËÑ¡Ïî£¬½«²»ÄÜ¶ÔÀà³ÉÔ±²¹È«
...
" ----------------------------------------------------
" showmarks.vim"{{{
" ×Ô¶¯Éú³É°ïÖúÎÄµµ,ÐèÒªÊÖ¶¯½¨Á¢docÎÄ¼þ¼Ð
...
" ÐèÒªÌí¼Ó»·¾³±äÁ¿
"if has("cscope")
"  set cscopetag   " Ê¹Ö§³ÖÓÃ Ctrl+]  ºÍ Ctrl+t ¿ì½Ý¼üÔÚ´úÂë¼äÌøÀ´ÌøÈ¥
